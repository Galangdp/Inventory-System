                        ...
                        <div class="form-group">
                                <label>Tanggal Masuk</label>
                                    <div class="input-group date" id="reservationdate4" data-target-input="nearest">
                                        <input name="tanggal_masuk" type="text" value="{{$barang -> tanggal_masuk}}" class="form-control datetimepicker-input" data-target="#reservationdate4"/>
                            ...
                            <div class="form-group">
                                <label>Tanggal Update</label>
                                    <div class="input-group date" id="reservationdate5" data-target-input="nearest">
                                        <input name="tanggal_update" type="text" value="{{$barang -> tanggal_update}}" class="form-control datetimepicker-input" data-target="#reservationdate5"/>
